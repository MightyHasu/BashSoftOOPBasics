...
public class StudentsRepository implements DataBase {
    ...
    public StudentsRepository(
            DataFilter filter,
            DataSorter sorter) {
        this.filter = (RepositoryFilter) filter;
        this.sorter = (RepositorySorter) sorter;
    }

    public SimpleSortedList<Course> getAllCourseSorted(Comparator<Course> cmp) {
            ...
            if (!line.isEmpty() && matcher.find()) {
                ...
                try {
                    ...
                    if (!this.students.containsKey(studentName)) {
                        Student student = new SoftUniStudent();
                        student.SoftUniStudent(studentName);
                        this.students.put(studentName, student);
                    }
                    if (!this.courses.containsKey(courseName)) {
                        Course course = new SoftUniCourse();
                        course.SoftUniCourse(courseName);
